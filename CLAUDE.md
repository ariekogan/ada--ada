# Personal AI Assistant — Agent Onboarding
...
You are working on A-Team solution **personal-ai-assistant**. Read this entire file before your first tool call.

---

## 1. What this solution is

Personal AI assistant — curated baseline (from ada).
...
4. ateam_build_and_run(solution_id: "personal-ai-assistant", github: true)
